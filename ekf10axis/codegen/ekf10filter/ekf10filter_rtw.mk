###########################################################################
## Makefile generated for component 'ekf10filter'. 
## 
## Makefile     : ekf10filter_rtw.mk
## Generated on : Wed May 21 14:41:54 2025
## Final product: ./ekf10filter.lib
...
PRODUCT_NAME              = ekf10filter
MAKEFILE                  = ekf10filter_rtw.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/My Thesis/ekf10axisV02
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = ../../..
COMPILER_COMMAND_FILE     = ekf10filter_rtw_comp.rsp
CMD_FILE                  = ekf10filter_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = ekf10filter.lib
...
DEFINES_STANDARD = -DMODEL=ekf10filter
...
SRCS = $(START_DIR)/codegen/lib/ekf10filter/rt_nonfinite.c $(START_DIR)/codegen/lib/ekf10filter/rtGetNaN.c $(START_DIR)/codegen/lib/ekf10filter/rtGetInf.c $(START_DIR)/codegen/lib/ekf10filter/ekf10filter.c
...
OBJS = rt_nonfinite.o rtGetNaN.o rtGetInf.o ekf10filter.o
...
%.o : $(START_DIR)/codegen/lib/ekf10filter/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/ekf10filter/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/ekf10filter/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/ekf10filter/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/ekf10filter/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rt_nonfinite.o : $(START_DIR)/codegen/lib/ekf10filter/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/codegen/lib/ekf10filter/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/codegen/lib/ekf10filter/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ekf10filter.o : $(START_DIR)/codegen/lib/ekf10filter/ekf10filter.c
	$(CC) $(CFLAGS) -o "$@" "$<"
