###########################################################################
## Makefile generated for component 'ekf10Init'. 
## 
## Makefile     : ekf10Init_rtw.mk
## Generated on : Tue Jun 03 11:44:28 2025
## Final product: ./ekf10Init.lib
...
COMPILER_COMMAND_FILE     = ekf10Init_rtw_comp.rsp
CMD_FILE                  = ekf10Init_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = ekf10Init.lib
...
DEFINES_STANDARD = -DMODEL=ekf10Init
...
SRCS = $(START_DIR)/codegen/lib/ekf10Init/rt_nonfinite.c $(START_DIR)/codegen/lib/ekf10Init/rtGetNaN.c $(START_DIR)/codegen/lib/ekf10Init/rtGetInf.c $(START_DIR)/codegen/lib/ekf10Init/ekf10Init.c
...
OBJS = rt_nonfinite.o rtGetNaN.o rtGetInf.o ekf10Init.o
...
%.o : $(START_DIR)/codegen/lib/ekf10Init/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/ekf10Init/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/ekf10Init/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/ekf10Init/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/ekf10Init/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rt_nonfinite.o : $(START_DIR)/codegen/lib/ekf10Init/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/codegen/lib/ekf10Init/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/codegen/lib/ekf10Init/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ekf10Init.o : $(START_DIR)/codegen/lib/ekf10Init/ekf10Init.c
	$(CC) $(CFLAGS) -o "$@" "$<"
